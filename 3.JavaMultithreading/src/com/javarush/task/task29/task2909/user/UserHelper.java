...
public class UserHelper {
    ...
    public void calculateRate(AtomicLong base, int age, boolean hasWork, boolean hasHouse) {
        base.set(base.get() + age / 100);
        base.set((long) (base.get() * (hasWork ? 1.1 : 0.9)));
        base.set((long) (base.get() * (hasHouse ? 1.1 : 0.9)));
    }
